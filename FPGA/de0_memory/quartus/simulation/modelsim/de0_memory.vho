...
ENTITY 	top IS
	...
	fnd_30_out : OUT std_logic_vector(6 DOWNTO 0);
	fnd_74_out : OUT std_logic_vector(6 DOWNTO 0)
	);
END top;
...
SIGNAL \d2_start~feeder_combout\ : std_logic;
SIGNAL \d2_start~q\ : std_logic;
SIGNAL \w_start~combout\ : std_logic;
...
SIGNAL \u_uart_rx|data_buffer[4]~2_combout\ : std_logic;
...
-- Equation(s):
-- \u_uart_rx|Equal0~2_combout\ = (!\u_uart_rx|cnt_rx_div\(8) & (\u_uart_rx|cnt_rx_div\(0) & (\u_uart_rx|cnt_rx_div\(1) & !\u_uart_rx|cnt_rx_div\(7))))
...
-- pragma translate_on
PORT MAP (
	dataa => \u_uart_rx|Equal2~0_combout\,
...
-- Equation(s):
-- \u_uart_rx|start_en~0_combout\ = (!\u_uart_rx|uart_rxd_d3~q\ & (\u_uart_rx|uart_rxd_d2~q\ & !\u_uart_rx|rx_en~q\))
...
-- Equation(s):
-- \u_uart_rx|cnt_bit~0_combout\ = (!\u_uart_rx|start_en~q\ & (!\u_uart_rx|Equal0~3_combout\ & \u_uart_rx|rx_en~q\))
...
-- Equation(s):
-- \u_uart_rx|cnt_bit[3]~3_combout\ = (\u_uart_rx|Add1~0_combout\ & ((\u_uart_rx|cnt_bit~0_combout\) # ((\u_uart_rx|cnt_bit\(3) & \u_uart_rx|cnt_bit[3]~2_combout\)))) # (!\u_uart_rx|Add1~0_combout\ & (((\u_uart_rx|cnt_bit\(3) & 
-- \u_uart_rx|cnt_bit[3]~2_combout\))))
...
PORT MAP (
	...
	datad => \u_uart_rx|cnt_bit[3]~2_combout\,
...
-- Equation(s):
-- \u_uart_rx|cnt_bit[2]~5_combout\ = (\u_uart_rx|Add1~1_combout\ & ((\u_uart_rx|cnt_bit~0_combout\) # ((\u_uart_rx|cnt_bit\(2) & \u_uart_rx|cnt_bit[3]~2_combout\)))) # (!\u_uart_rx|Add1~1_combout\ & (((\u_uart_rx|cnt_bit\(2) & 
-- \u_uart_rx|cnt_bit[3]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \u_uart_rx|Add1~1_combout\,
	datab => \u_uart_rx|cnt_bit~0_combout\,
...
PORT MAP (
	...
	datad => \u_uart_rx|rx_en~0_combout\,
...
-- Equation(s):
-- \u_uart_rx|cnt_rx_div[6]~19_combout\ = ((!\u_uart_rx|Equal2~1_combout\ & (\u_uart_rx|cnt_rx_div\(12) & !\u_uart_rx|Equal2~2_combout\))) # (!\u_uart_rx|rx_en~q\)
...
PORT MAP (
	...
	datad => \u_uart_rx|Equal2~2_combout\,
...
-- Equation(s):
-- \u_uart_rx|Equal0~0_combout\ = (\u_uart_rx|cnt_rx_div\(4)) # (((\u_uart_rx|cnt_rx_div\(2)) # (!\u_uart_rx|cnt_rx_div\(3))) # (!\u_uart_rx|cnt_rx_div\(5)))
...
-- Equation(s):
-- \u_uart_rx|Equal0~1_combout\ = (((\u_uart_rx|cnt_rx_div\(6)) # (\u_uart_rx|cnt_rx_div\(10))) # (!\u_uart_rx|cnt_rx_div\(11))) # (!\u_uart_rx|cnt_rx_div\(9))
...
-- pragma translate_on
PORT MAP (
	dataa => \u_uart_rx|cnt_rx_div\(9),
	datab => \u_uart_rx|cnt_rx_div\(11),
	datac => \u_uart_rx|cnt_rx_div\(6),
	datad => \u_uart_rx|cnt_rx_div\(10),
	combout => \u_uart_rx|Equal0~1_combout\);

-- Location: LCCOMB_X8_Y6_N4
\u_uart_rx|Equal0~3\ : cycloneiii_lcell_comb
-- Equation(s):
-- \u_uart_rx|Equal0~3_combout\ = (\u_uart_rx|Equal0~0_combout\) # ((\u_uart_rx|Equal0~1_combout\) # ((\u_uart_rx|cnt_rx_div\(12)) # (!\u_uart_rx|Equal0~2_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \u_uart_rx|Equal0~0_combout\,
...
-- Equation(s):
-- \u_uart_rx|cnt_bit~6_combout\ = (\u_uart_rx|rx_en~q\ & ((\u_uart_rx|start_en~q\) # ((!\u_uart_rx|Equal0~3_combout\ & !\u_uart_rx|cnt_bit\(0)))))
...
-- Equation(s):
-- \u_Mem_Controller|wen~1_combout\ = (!\u_uart_rx|cnt_bit\(0) & !\u_uart_rx|cnt_bit\(2))
...
-- Equation(s):
-- \d_start~0_combout\ = !\push_read~input_o\
...
\d2_start~feeder\ : cycloneiii_lcell_comb
-- Equation(s):
-- \d2_start~feeder_combout\ = \d_start~q\
...
PORT MAP (
	datad => \d_start~q\,
	combout => \d2_start~feeder_combout\);
...
w_start : cycloneiii_lcell_comb
-- Equation(s):
-- \w_start~combout\ = (!\d2_start~q\ & \d_start~q\)
...
-- Equation(s):
-- \u_Mem_Controller|raddr[1]~1_combout\ = \u_Mem_Controller|raddr\(1) $ (((\u_Mem_Controller|raddr\(0) & \u_Mem_Controller|ren~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \u_Mem_Controller|raddr\(0),
...
-- Equation(s):
-- \u_Mem_Controller|clear~0_combout\ = (!\d2_start~q\ & (\u_Mem_Controller|raddr\(1) & (\u_Mem_Controller|raddr\(0) & \d_start~q\)))
...
PORT MAP (
	dataa => \d2_start~q\,
	datab => \u_Mem_Controller|raddr\(1),
	datac => \u_Mem_Controller|raddr\(0),
	datad => \d_start~q\,
...
-- Equation(s):
-- \u_Mem_Controller|waddr[0]~1_combout\ = (\u_Mem_Controller|clear~q\) # ((!\u_Mem_Controller|waddr\(2) & \u_Mem_Controller|wen~q\))
...
-- Equation(s):
-- \u_Mem_Controller|waddr~3_combout\ = (!\u_Mem_Controller|clear~q\ & (\u_Mem_Controller|waddr\(0) & (\u_Mem_Controller|waddr\(1) & \u_Mem_Controller|wen~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \u_Mem_Controller|clear~q\,
	datab => \u_Mem_Controller|waddr\(0),
	datac => \u_Mem_Controller|waddr\(1),
	datad => \u_Mem_Controller|wen~q\,
...
-- Equation(s):
-- \u_Mem_Controller|wen~0_combout\ = (\u_uart_rx|cnt_bit\(3) & (((\u_Mem_Controller|waddr\(0)) # (\u_Mem_Controller|waddr\(1))) # (!\u_Mem_Controller|waddr\(2))))
...
-- pragma translate_on
PORT MAP (
	dataa => \u_Mem_Controller|waddr\(2),
	datab => \u_Mem_Controller|waddr\(0),
	datac => \u_Mem_Controller|waddr\(1),
	datad => \u_uart_rx|cnt_bit\(3),
...
-- Equation(s):
-- \u_Mem_Controller|wen~2_combout\ = (\u_uart_rx|cnt_bit\(1) & (\u_Mem_Controller|wen~1_combout\ & (!\u_uart_rx|Equal0~3_combout\ & \u_Mem_Controller|wen~0_combout\)))
...
PORT MAP (
	dataa => \u_uart_rx|cnt_bit\(1),
	datab => \u_Mem_Controller|wen~1_combout\,
	datac => \u_uart_rx|Equal0~3_combout\,
...
-- Equation(s):
-- \u_uart_rx|data_buffer~10_combout\ = (!\u_uart_rx|uart_rxd_d2~q\ & ((\u_uart_rx|cnt_bit\(1)) # ((\u_uart_rx|cnt_bit\(3)) # (!\u_Mem_Controller|wen~1_combout\))))
...
-- Equation(s):
-- \u_uart_rx|data_buffer~11_combout\ = (\u_uart_rx|rx_en~q\ & ((\u_uart_rx|Equal0~3_combout\ & ((\u_uart_rx|data_buffer\(9)))) # (!\u_uart_rx|Equal0~3_combout\ & (!\u_uart_rx|data_buffer~10_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \u_uart_rx|data_buffer~10_combout\,
...
-- Equation(s):
-- \u_uart_rx|data_buffer~9_combout\ = (\u_uart_rx|rx_en~q\ & \u_uart_rx|data_buffer\(9))
...
-- Equation(s):
-- \u_uart_rx|data_buffer[4]~1_combout\ = (\u_uart_rx|Equal0~0_combout\) # (\u_uart_rx|cnt_rx_div\(12))
...
\u_uart_rx|data_buffer[4]~2\ : cycloneiii_lcell_comb
-- Equation(s):
-- \u_uart_rx|data_buffer[4]~2_combout\ = ((!\u_uart_rx|data_buffer[4]~1_combout\ & (\u_uart_rx|Equal0~2_combout\ & !\u_uart_rx|Equal0~1_combout\))) # (!\u_uart_rx|rx_en~q\)
...
-- pragma translate_on
PORT MAP (
	dataa => \u_uart_rx|data_buffer[4]~1_combout\,
	datab => \u_uart_rx|Equal0~2_combout\,
	datac => \u_uart_rx|Equal0~1_combout\,
	datad => \u_uart_rx|rx_en~q\,
	combout => \u_uart_rx|data_buffer[4]~2_combout\);
...
PORT MAP (
	clk => \clk~inputclkctrl_outclk\,
	d => \u_uart_rx|data_buffer~9_combout\,
	clrn => \n_rst~input_o\,
	ena => \u_uart_rx|data_buffer[4]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \u_uart_rx|data_buffer~8_combout\ = (\u_uart_rx|rx_en~q\ & \u_uart_rx|data_buffer\(8))
...
-- Equation(s):
-- \u_uart_rx|data_buffer~7_combout\ = (\u_uart_rx|rx_en~q\ & \u_uart_rx|data_buffer\(7))
...
-- Equation(s):
-- \u_uart_rx|data_buffer~6_combout\ = (\u_uart_rx|rx_en~q\ & \u_uart_rx|data_buffer\(6))
...
-- Equation(s):
-- \u_uart_rx|data_buffer~5_combout\ = (\u_uart_rx|rx_en~q\ & \u_uart_rx|data_buffer\(5))
...
-- Equation(s):
-- \u_uart_rx|data_buffer~4_combout\ = (\u_uart_rx|rx_en~q\ & \u_uart_rx|data_buffer\(4))
...
-- Equation(s):
-- \u_uart_rx|data_buffer~3_combout\ = (\u_uart_rx|rx_en~q\ & \u_uart_rx|data_buffer\(3))
...
-- Equation(s):
-- \u_fnd_1|WideOr6~0_combout\ = (\u_Mem_Controller|fnd_data\(3) & (\u_Mem_Controller|fnd_data\(0) & (\u_Mem_Controller|fnd_data\(2) $ (\u_Mem_Controller|fnd_data\(1))))) # (!\u_Mem_Controller|fnd_data\(3) & (!\u_Mem_Controller|fnd_data\(1) & 
...
-- pragma translate_on
PORT MAP (
	dataa => \u_Mem_Controller|fnd_data\(3),
	datab => \u_Mem_Controller|fnd_data\(2),
	datac => \u_Mem_Controller|fnd_data\(0),
	datad => \u_Mem_Controller|fnd_data\(1),
	combout => \u_fnd_1|WideOr6~0_combout\);

-- Location: LCCOMB_X24_Y27_N26
\u_fnd_1|WideOr5~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \u_fnd_1|WideOr5~0_combout\ = (\u_Mem_Controller|fnd_data\(2) & (\u_Mem_Controller|fnd_data\(3) $ (\u_Mem_Controller|fnd_data\(0) $ (\u_Mem_Controller|fnd_data\(1))))) # (!\u_Mem_Controller|fnd_data\(2) & (\u_Mem_Controller|fnd_data\(3) & 
-- (\u_Mem_Controller|fnd_data\(0) & \u_Mem_Controller|fnd_data\(1))))
...
-- Equation(s):
-- \u_fnd_1|WideOr4~0_combout\ = (\u_Mem_Controller|fnd_data\(3) & (\u_Mem_Controller|fnd_data\(2) & ((\u_Mem_Controller|fnd_data\(1)) # (!\u_Mem_Controller|fnd_data\(0))))) # (!\u_Mem_Controller|fnd_data\(3) & (!\u_Mem_Controller|fnd_data\(2) & 
-- (!\u_Mem_Controller|fnd_data\(0) & \u_Mem_Controller|fnd_data\(1))))
...
-- Equation(s):
-- \u_fnd_1|WideOr1~0_combout\ = (\u_Mem_Controller|fnd_data\(1) & (!\u_Mem_Controller|fnd_data\(3) & (!\u_Mem_Controller|fnd_data\(2)))) # (!\u_Mem_Controller|fnd_data\(1) & (\u_Mem_Controller|fnd_data\(0) & (\u_Mem_Controller|fnd_data\(3) $ 
-- (!\u_Mem_Controller|fnd_data\(2)))))
...
-- Equation(s):
-- \u_fnd_1|WideOr0~0_combout\ = (\u_Mem_Controller|fnd_data\(0) & ((\u_Mem_Controller|fnd_data\(3)) # (\u_Mem_Controller|fnd_data\(2) $ (\u_Mem_Controller|fnd_data\(1))))) # (!\u_Mem_Controller|fnd_data\(0) & ((\u_Mem_Controller|fnd_data\(1)) # 
-- (\u_Mem_Controller|fnd_data\(3) $ (\u_Mem_Controller|fnd_data\(2)))))
...
-- Equation(s):
-- \u_fnd_2|WideOr6~0_combout\ = (\u_Mem_Controller|fnd_data\(7) & (\u_Mem_Controller|fnd_data\(4) & (\u_Mem_Controller|fnd_data\(5) $ (\u_Mem_Controller|fnd_data\(6))))) # (!\u_Mem_Controller|fnd_data\(7) & (!\u_Mem_Controller|fnd_data\(5) & 
...
-- pragma translate_on
PORT MAP (
	dataa => \u_Mem_Controller|fnd_data\(7),
	datab => \u_Mem_Controller|fnd_data\(5),
	datac => \u_Mem_Controller|fnd_data\(6),
	datad => \u_Mem_Controller|fnd_data\(4),
	combout => \u_fnd_2|WideOr6~0_combout\);

-- Location: LCCOMB_X23_Y19_N10
\u_fnd_2|WideOr5~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \u_fnd_2|WideOr5~0_combout\ = (\u_Mem_Controller|fnd_data\(6) & (\u_Mem_Controller|fnd_data\(7) $ (\u_Mem_Controller|fnd_data\(5) $ (\u_Mem_Controller|fnd_data\(4))))) # (!\u_Mem_Controller|fnd_data\(6) & (\u_Mem_Controller|fnd_data\(7) & 
-- (\u_Mem_Controller|fnd_data\(5) & \u_Mem_Controller|fnd_data\(4))))
...
-- Equation(s):
-- \u_fnd_2|WideOr4~0_combout\ = (\u_Mem_Controller|fnd_data\(7) & (\u_Mem_Controller|fnd_data\(6) & ((\u_Mem_Controller|fnd_data\(5)) # (!\u_Mem_Controller|fnd_data\(4))))) # (!\u_Mem_Controller|fnd_data\(7) & (\u_Mem_Controller|fnd_data\(5) & 
-- (!\u_Mem_Controller|fnd_data\(6) & !\u_Mem_Controller|fnd_data\(4))))
...
-- Equation(s):
-- \u_fnd_2|WideOr3~0_combout\ = (\u_Mem_Controller|fnd_data\(5) & ((\u_Mem_Controller|fnd_data\(6) & ((\u_Mem_Controller|fnd_data\(4)))) # (!\u_Mem_Controller|fnd_data\(6) & (\u_Mem_Controller|fnd_data\(7) & !\u_Mem_Controller|fnd_data\(4))))) # 
...
-- Equation(s):
-- \u_fnd_2|WideOr2~0_combout\ = (\u_Mem_Controller|fnd_data\(5) & (!\u_Mem_Controller|fnd_data\(7) & ((\u_Mem_Controller|fnd_data\(4))))) # (!\u_Mem_Controller|fnd_data\(5) & ((\u_Mem_Controller|fnd_data\(6) & (!\u_Mem_Controller|fnd_data\(7))) # 
-- (!\u_Mem_Controller|fnd_data\(6) & ((\u_Mem_Controller|fnd_data\(4))))))
...
-- Equation(s):
-- \u_fnd_2|WideOr1~0_combout\ = (\u_Mem_Controller|fnd_data\(5) & (!\u_Mem_Controller|fnd_data\(7) & (!\u_Mem_Controller|fnd_data\(6)))) # (!\u_Mem_Controller|fnd_data\(5) & (\u_Mem_Controller|fnd_data\(4) & (\u_Mem_Controller|fnd_data\(7) $ 
-- (!\u_Mem_Controller|fnd_data\(6)))))
...
-- Equation(s):
-- \u_fnd_2|WideOr0~0_combout\ = (\u_Mem_Controller|fnd_data\(4) & ((\u_Mem_Controller|fnd_data\(7)) # (\u_Mem_Controller|fnd_data\(5) $ (\u_Mem_Controller|fnd_data\(6))))) # (!\u_Mem_Controller|fnd_data\(4) & ((\u_Mem_Controller|fnd_data\(5)) # 
-- (\u_Mem_Controller|fnd_data\(7) $ (\u_Mem_Controller|fnd_data\(6)))))
